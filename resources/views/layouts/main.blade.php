...
<html lang="en">
<head>
    <title>Toukou - E-Commerce Toko Kelontong</title>
    <meta charset="utf-8">
    ...
    <!--Favicon-->
    <link rel="shortcut icon" href="{{ url('img/0/favicon.ico')}}" type="image/x-icon">
    <link rel="icon" href="{{ url('img/0/favicon.ico')}}" type="image/x-icon">
    
    <!-- css files -->
    <link rel="stylesheet" type="text/css" href="{{ url('css/0/bootstrap.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{ url('css/0/font-awesome.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{ url('css/0/owl.carousel.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{ url('css/0/owl.theme.default.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{ url('css/0/animate.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{ url('css/0/swiper.css')}}" />
    
    
    <!-- this is default skin you can replace that with: dark.css, yellow.css, red.css ect -->
    <link id="pagestyle" rel="stylesheet" type="text/css" href="{{ url('css/0/default.css')}}" />
    ...
    <body>
        ...
        <div class="topBar">
            <div class="container">
                <ul class="list-inline pull-left hidden-sm hidden-xs">
                    <li><i class="fa fa-phone mr-5"></i>+62 813 2992 6525</li>
                    <li><i class="fa fa-envelope mr-5"></i>admin@toukou.id</li>
                </ul>
                ...
                <ul class="topBarNav pull-right">                    
                    <li class="linkdown">
                        ...
                        <ul class="w-150">
                            ...
                            <li class="divider"></li>
                            <li><a href="wishlist.html">Disukai (5)</a></li>
                    ...
                    <li class="linkdown">
                        <a href="javascript:void(0);">
                            ...
                            <span class="hidden-xs">
                                Keranjang<sup class="text-primary">(3)</sup>
                                <i class="fa fa-angle-down ml-5"></i>
                            </span>    
                        </a>
                        <ul class="cart w-250">
                                    ...
                                    <ol class="items">
                                        <li> 
                                            <a href="shop-single-product-v1.html" class="product-image">
                                                <img src="{{ url('img/0/products/men_06.jpg')}}" alt="Sample Product ">
                                            </a>
                                        ...
                                        <li> 
                                            <a href="shop-single-product-v1.html" class="product-image">
                                                <img src="{{ url('img/0/products/shoes_01.jpg')}}" alt="Sample Product ">
                                            </a>
                                            <div class="product-details">
                                                <div class="close-icon"> 
                                                    <a href="javascript:void(0);"><i class="fa fa-close"></i></a>
                                        ...
                                        <li> 
                                            <a href="shop-single-product-v1.html" class="product-image">
                                                <img src="{{ url('img/0/products/bags_07.jpg') }}" alt="Sample Product ">
                                            </a>
                                            <div class="product-details">
                                                <div class="close-icon"> 
                                                    <a href="javascript:void(0);"><i class="fa fa-close"></i></a>
                            ...
                            <li>
                                <div class="cart-footer">
                                    <a href="cart.html" class="pull-left"><i class="fa fa-cart-plus mr-5"></i>Lihat Keranjang</a>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="javascript:void(0);" class="navbar-brand">
                        <img src="{{ url('img/0/logo.png')}}" alt="logo">
                    </a>
                </div>
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            <ul class="col-sm-3">
                                                ...
                                                <li class="active"><a href="shop-full-width-filter-top.html">Full Width Filters Top</a></li>
                                            ...
                                            <div class="col-xs-12 col-sm-3">
                                                <a href="javascript:void(0);">
                                                    <figure class="zoom-out">
                                                        <img alt="" src="{{ url('img/0/banners/collection_01.jpg')}}">
                                                    </figure>
                                                </a>
                                            </div><!-- end col -->
                                            <div class="col-xs-12 col-sm-3">
                                                <a href="javascript:void(0);">
                                                    <figure class="zoom-in">
                                                        <img alt="" src="{{ url('img/0/banners/collection_02.jpg')}}">
                                                    </figure>
                                                </a>
                                            </div><!-- end col -->
                                            <div class="col-xs-12 col-sm-3">
                                                <a href="javascript:void(0);">
                                                    <figure class="zoom-out">
                                                        <img alt="" src="{{ url('img/0/banners/collection_03.jpg')}}">
                                                    </figure>
                                                </a>
                                            </div><!-- end col -->
                                            <div class="col-xs-12 col-sm-3">
                                                <a href="javascript:void(0);">
                                                    <figure class="zoom-in">
                                                        <img alt="" src="{{ url('img/0/banners/collection_04.jpg')}}">
                                                    </figure>
                                                </a>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown yamm-fw">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle">
                                <span class="hidden-sm">Kategori</span><i class="fa fa-bars ml-5"></i>
                            </a>
                            <ul class="dropdown-menu">
                                <li>
                                    <!-- Content container to add padding -->
                                    <div class="yamm-content">
                                        <div class="row">                                            
                                            <div class="col-sm-9">
                                                <h6 class="text-center">Buat Akun - <span class="text-primary">Belanja Lebih Mudah</span></h6>
                                                <figure>
                                                    <a href="javascript:void(0);">
                                                        <img alt="" src="{{ url('img/0/banners/banner_big.jpg')}}">
                                                    </a>
                                                </figure>
                                            </div><!-- end col -->
                                            <ul class="col-xs-12 col-sm-3">
                                                ...
                                                <li><a href="javascript:void(0);">Cemilan</a></li>
                                                <li><a href="javascript:void(0);">Sabun</a></li>
                                                <li><a href="javascript:void(0);">Rokok</a></li>                                                
                                            </ul>
                                        </div><!-- end row -->
                                    </div><!-- end yamn-content -->
                                </li>
                                        ...
                                        <div class='carousel slide product-slider' data-ride='carousel' data-interval="false">
                                            <div class='carousel-inner'>
                                                <div class='item active'>
                                                    <figure>
                                                        <img src='{{ url("img/0/products/men_01.jpg")}}' alt='' />
                                                    </figure>
                                                </div><!-- end item -->
                                                    <figure>
                                                        <img src='{{ url("img/0/products/men_03.jpg")}}' alt='' />
                                                    </figure>
                                                </div><!-- end item -->
                                                <div class='item'>
                                                    <figure>
                                                ...
                                                <div class='item'>
                                                    <figure>
                                                        <img src='{{ url("img/0/products/men_05.jpg")}}' alt=''/>
                                                    </figure>
                                                </div><!-- end item -->
                                            ...
                                            <ol class='carousel-indicators mCustomScrollbar meartlab'>
                                                <li data-target='.product-slider' data-slide-to='0' class='active'><img src='{{ url("img/0/products/men_01.jpg")}}' alt='' /></li>
                                                <li data-target='.product-slider' data-slide-to='1'><img src='{{ url("img/0/products/men_02.jpg")}}' alt='' /></li>
                                                <li data-target='.product-slider' data-slide-to='2'><img src='{{ url("img/0/products/men_03.jpg")}}' alt='' /></li>
                                                <li data-target='.product-slider' data-slide-to='3'><img src='{{ url("img/0/products/men_04.jpg")}}' alt='' /></li>
                                                <li data-target='.product-slider' data-slide-to='4'><img src='{{ url("img/0/products/men_05.jpg")}}' alt='' /></li>
                                                <li data-target='.product-slider' data-slide-to='5'><img src='{{ url("img/0/products/men_06.jpg")}}' alt='' /></li>
        ...
        <!-- JavaScript Files -->
        <script type="text/javascript" src="{{ url('js/0/jquery-3.1.1.min.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/bootstrap.min.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/owl.carousel.min.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/jquery.downCount.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/nouislider.min.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/jquery.sticky.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/pace.min.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/star-rating.min.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/wow.min.js')}}"></script>
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js"></script>
        <script type="text/javascript" src="{{ url('js/0/gmaps.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/swiper.min.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/main.js')}}"></script>
        <script type="text/javascript" src="{{ url('js/0/font-awesome.min.js')}}"></script>
